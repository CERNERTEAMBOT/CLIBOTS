...
local function lock_group_etehad(msg, data, target)
  ...
  if group_super_lock == 'yes' then
    return 'super setting is already locked'
  else
    data[tostring(target)]['settings']['super'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'super setting has been locked'
  end
end

local function unlock_group_super(msg, data, target)
  if not is_momod(msg) then
    return
  end
  local group_super_lock = data[tostring(target)]['settings']['super']
  if group_super_lock == 'no' then
    return 'super setting is not locked'
  else
    data[tostring(target)]['settings']['super'] = 'no'
    save_data(_config.moderation.data, data)
    return 'super setting has been unlocked'
  end
end
...
function show_supergroup_settingsmod(msg, target)
  ...
  local text = "<b>SuperGroup settings\n>Lock links ~ <code>"..settings.lock_link.."</code>\n<b>>Lock contacts'<b>~ <code>"..settings.lock_contacts.."</code\n>Lock flood ~ <code>"..settings.flood.."</code>\n>Flood sensitivity ~ 200|<code>"..NUM_MSG_MAX.."</code>\n>Lock spam ~ <code>"..settings.lock_spam.."</code>\n>Lock Arabic ~ <code>"..settings.lock_arabic.."</code>\n>Lock Member ~ <code>"..settings.lock_member.."</code>\n>Lock RTL ~ <code>"..settings.lock_rtl.."</code>\n>Lock Tgservice ~ <code>"..settings.lock_tgservice.."</code>\n>Lock sticker ~ <code>"..settings.lock_sticker.."</code>\n>Lock inline ~ <code>"..settings.inline.."</code>\n>Lock tag(#) ~ <code>"..settings.tag.."</code>\n>Lock emoji ~ <code>"..settings.emoji.."</code>\n>Lock english ~ <code>"..settings.english.."</code>\n>Lock fwd(forward) ~ <code>"..settings.fwd.."</code>\n>Lock reply ~ <code>"..settings.reply.."</code>\n>Lock join ~ <code>"..settings.join.."</code>\n>Lock username(@) ~ <code>"..settings.username.."</code>\n>Lock media ~ <code>"..settings.media.."</code>\n>Lock fosh ~ <code>"..settings.fosh.."</code>\n>Lock leave ~ <code>"..settings.leave.."</code>\n>Lock bots ~ <code>"..bots_protection.."</code>\n>Lock operator ~ <code>"..settings.operator.."</code>\n___________CerNer Team______________\nsuper Settings ~ <code>"..settings.super.."</code>\n>Lock all ~ <code>"..settings.all.."</code>\n>public ~ <code>"..settings.public.."</code>\n>strict settings ~ <code>"..settings.strict.."</code>\n</b><i>CerNerTeam</i>\n<b>channel Team</b> @CerNerTeam"
  return text
end
